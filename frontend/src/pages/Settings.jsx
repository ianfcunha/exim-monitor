...
import { deleteUser, fetchAlertHistory, fetchAlertSettings, fetchUsers, inviteUser, saveAlertSettings, testEmail, testTelegram } from '../api/client'
...
function UsersSection() {
  ...
  const handleDelete = async (id, username) => {
    if (!confirm(`Remover o usuário "${username}"? O acesso será revogado imediatamente.`)) return
    try {
      await deleteUser(id)
      load()
    } catch (e) {
    ...
    <Section title="Usuários e Convites">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        <button
          ...
          style={{
            ...
            background: showForm ? '#F0F9FF' : '#F8FAFC',
      ...
      {showForm && (
        <form onSubmit={handleInvite} style={{
          ...
          <p style={{ fontSize: 11, fontWeight: 700, color: '#0369A1', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 12 }}>
            Novo convite
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto auto', gap: 8, alignItems: 'flex-end' }}>
            <div>
              ...
              <input
                ...
                placeholder="colega@empresa.com" required
                style={{
            ...
            <div>
              ...
              <select
                ...
                style={{ padding: '8px 10px', borderRadius: 7, fontSize: 12, border: '1px solid #BAE6FD', background: '#fff', color: '#0F172A', cursor: 'pointer' }}
              >
          ...
          <p style={{ fontSize: 11, color: '#64748B', marginTop: 8 }}>
            <strong>Viewer</strong> — apenas visualiza o dashboard, sem executar ações.<br/>
            <strong>Admin</strong> — acesso completo ao dashboard e configurações.
          </p>
        </form>
      )}
          ...
          {users.map(u => (
            <div key={u.id} style={{
              ...
              <div style={{
                ...
                background: ROLE_BG[u.role], border: `1px solid ${ROLE_COLOR[u.role]}30`,
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: 13, fontWeight: 700, color: ROLE_COLOR[u.role],
              }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 11, color: '#94A3B8', marginTop: 2 }}>
                  {u.invite_pending ? 'Aguardando aceite' : u.email}
                  {u.last_login_at && (
                    <span style={{ marginLeft: 10 }}>
                      · último login: {fmtDate(u.last_login_at)}
                    </span>
                  )}
                </div>
              </div>
